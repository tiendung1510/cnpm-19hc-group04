    ...
    return (
      <div className="reporting__revenue-statistic reporting__block-style animated slideInUp">
        <Row style={{ width: '100%', position: 'relative', margin: 0 }} gutter={20} justify="center">
          <Col span={8}>
            <div className="reporting__revenue-statistic__widget --revenue-total animated fadeIn" style={{ animationDelay: '0.4s' }}>
          ...
          <Col span={8}>
            <div className="reporting__revenue-statistic__widget --payment-total animated fadeIn" style={{ animationDelay: '0.7s' }}>
              <div className="reporting__revenue-statistic__widget__content">
                <div className="reporting__revenue-statistic__widget__content__value">
                  <MinusCircleOutlined />
                  <NumberFormat
          ...
          <Col span={8}>
            <div className="reporting__revenue-statistic__widget --profit-total animated fadeIn" style={{ animationDelay: '0.9s' }}>
              <div className="reporting__revenue-statistic__widget__content">
                <div className="reporting__revenue-statistic__widget__content__value">
                  <CoffeeOutlined />
                  <NumberFormat
